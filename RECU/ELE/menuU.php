              ...
              <a href="../login.php"><span class="icon-user"></span>Usuario</a>
                <ul class="USL">
                      <div id="US">
                        ...
                        <ul class="USA">
                            <li><a href="agregar.php"><span class="icon-subir"></span>Nuevo articulo</a></li>
                            <li><a href="crear.php"><span class="icon-usernew"></span>Crear usuario</a></li>
                            <li><a href="perfil.php"><span class="icon-config"></span>Perfil de usuario</a></li>
                            <li><a href="../index.php"><span class="icon-salir"></span>Cerrar sesión</a></li>
                        </ul>
                        <ul class="USC">
                            <li><a href="favoritos.php"><span class="icon-fav"></span>Favoritos</a></li>
                            <li><a href="perfil.php"><span class="icon-config"></span>Editar perfil</a></li>
                            <li><a href="../index.php"><span class="icon-salir"></span>Cerrar sesión</a></li>
                        </ul>
                      </div>
                </ul>
            ...
            <li class="CAM">
                ...
                <ul class="CAS">
                    ...
                    while($mostrar=mysqli_fetch_array($result)){ 
                        $link = '../PAG/categoria.php?cat='.$mostrar['cat_id'];  
                    ?>
